...
import { spawnFFmpeg, runFFmpeg, type FFmpegProcess } from './process/spawn.js';
...
import {
  ...
  type CodecCandidate,
  type GuardResult,
} from './compat/guards.js';
import type { VersionInfo } from './types/version.js';
import type { GlobalOptions, InputOptions, OutputOptions } from './types/options.js';
...
export class FFmpegBuilder {
  ...
  spawn(opts?: { parseProgress?: boolean; totalDurationUs?: number }): FFmpegProcess {
    const spawnOpts: import('./process/spawn.js').SpawnOptions = {
      binary: this._binary,
      args: this.buildArgs(),
